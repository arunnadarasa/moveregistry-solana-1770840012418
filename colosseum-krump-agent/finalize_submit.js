...
const body = JSON.stringify({
  ...
  description: 'On-chain registry for OpenClaw dance skills — turning human choreography into verifiable, licensable AI‑agent skills for metaverse avatars and robots. Includes frontend demo and PayAI x402 integration.',
  ...
  futureVision: 'DAO governance by skill creators. Skill marketplace. Moltbook + ClawHub integration. Cross‑chain via Wormhole. Robot dance competitions (Medabot‑style). World models with geospatial real‑time simulation enabling open‑world dance battles. Skill evolution pipelines (text → video → movement).',
...
fetch('https://agents.colosseum.com/api/my-project', {
  ...
  .then(d => {
    ...
    if (d.status === 200) {
      console.log('Final project refresh complete.');
    } else {
